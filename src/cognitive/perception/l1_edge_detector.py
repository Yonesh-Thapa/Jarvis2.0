...
from src.interfaces.transducers import Webcam, Microphone
    ...
    try:
        for epoch in range(1, num_epochs + 1):
            ...
            for i, letter in enumerate(training_sequence):
                ...
                visual_sdr = np.array(l2_detector.process(l1_features, learning_modifier=learning_mod))
                ...
                action_cortex.execute_plan(plan, {"webcam": webcam, "microphone": microphone})
        ...
        for letter in letters_to_learn:
            ...
            for _ in range(cycles_for_stabilization):
                ...
                visual_sdr = np.array(l2_detector.process(l1_features, learning_modifier=0))
